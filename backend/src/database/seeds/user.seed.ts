...
export async function seedUsers(dataSource: DataSource): Promise<void> {
  ...
  await dataSource.query(`
    INSERT IGNORE INTO users (first_name,last_name,  email, password, roleId, is_active, customer_id,avatar_url)
    VALUES 
      ('Super Admin', 'Super Admin',    'superadmin@app.com',  '${superadminPassword}', ${roleMap['SUPERADMIN']}, 1, NULL,NULL),
      ('client admin', 'client admin',    'admin_mtec@gmail.com',  '${superadminPassword}', ${roleMap['CUSTOMER_ADMIN']}, 1, 2 ,NULL),
      ('user m-tec', 'user m-tec',    'user_mtec@gmail.com',  '${superadminPassword}', ${roleMap['CUSTOMER_OPERATOR']}, 1, 2 ,NULL),
