...
export default function AudioAlerteBngrcChooseMode() {
    ...
    <AppLayout>
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="bg-white border-b border-slate-200 px-4 py-4">
          <button
            onClick={() => navigate("/audio-alerte-bngrc")}
          ...
          <h1 className="text-xl font-semibold text-slate-900">Nouvel audio BNGRC</h1>
