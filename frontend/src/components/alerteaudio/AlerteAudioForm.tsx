...
export interface AlerteAudioFormData {
  ...
  // cascade helpers (non envoyés au backend)
  alerteId:          number;
  alerteTypeId:      number;
...
export function AlerteAudioForm({ initialData, onSubmit, loading, error }: Props) {
  ...
  const isValid = form.sousCategorieAlerteId > 0 && (isEdit || !!file);

  return (
    <div className="sirene-form-page">
      <div className="sirene-page-header">
        <button className="btn-back" onClick={() => navigate("/alerte-audios")}>
      ...
      <form onSubmit={handleSubmit} className="sirene-form-layout">
        ...
        <div className="sirene-form-card">
          ...
          {/* Mobile ID généré — affiché en lecture seule en mode édition */}
          ...
          <div className="sirene-fields-grid">
            ...
            <div className="sirene-field" style={{ gridColumn: "1/-1" }}>
              ...
              <textarea rows={2} value={form.description}
                ...
                placeholder="Description de l'audio…" style={{ resize: "vertical" }} />
            </div>
          </div>
        </div>
        ...
        <div className="sirene-form-card">
          ...
          <div className="sirene-fields-grid">
            <div className="sirene-field">
              <label>Alerte</label>
              <select value={form.alerteId || ""}
                onChange={e => { const v = Number(e.target.value); setForm(f => ({ ...f, alerteId: v, alerteTypeId: 0, categorieAlerteId: 0, sousCategorieAlerteId: 0 })); }}>
            ...
            <div className="sirene-field">
              ...
              <select value={form.alerteTypeId || ""} disabled={!form.alerteId}
                onChange={e => { const v = Number(e.target.value); setForm(f => ({ ...f, alerteTypeId: v, categorieAlerteId: 0, sousCategorieAlerteId: 0 })); }}>
            ...
            <div className="sirene-field">
              ...
              <select value={form.categorieAlerteId || ""} disabled={!form.alerteTypeId}
                onChange={e => { const v = Number(e.target.value); setForm(f => ({ ...f, categorieAlerteId: v, sousCategorieAlerteId: 0 })); }}>
            ...
            <div className="sirene-field">
              ...
              <select required value={form.sousCategorieAlerteId || ""} disabled={!form.categorieAlerteId}
                ...
                {filteredSousCats.map((s: any) => {
                  ...
                  return <option key={s.id} value={s.id} disabled={isUsed}>
                    {s.name}{isUsed ? " (déjà utilisé)" : ""}
                  </option>;
                })}
              </select>
            </div>
